...
import * as Alert from "../../shared/components/Alert.bs.js";
...
function Content$Trigger(Props) {
  ...
  var match = Hooks.usePeer(state.remoteHostId, setErrorMessage);
  var connections = match[2];
  ...
  var connectionCount = Belt_List.length(connections);
                  ...
                  className: "overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl sm:my-8 sm:w-full sm:max-w-md"
                      ...
                      className: "py-4"
                            ...
                            onClick: (function (param) {
                                ...
                                Belt_List.forEach(connections, (function (connection) {
                      ...
                      className: "inline-block overflow-hidden rounded-lg bg-white px-2 py-3 shadow"
                        ...
                        }, String(connectionCount))), msg !== undefined ? React.createElement(Alert.make, {
                        children: msg
